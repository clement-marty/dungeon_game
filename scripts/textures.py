...
def object_variant_matrix(size: tuple[int, int], object_textures: list[GameSprites._Texture], random_seed: int, fill: float = 0.25) :
    ...
    final_matrix = np.full(shape=(*size, 2), fill_value=None)
